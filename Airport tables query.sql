...
--Morao sam promijeniti ime atributa iz Condition u Status jer 
--je condition očito neka ključna riječ pa mi je to zadavalo
--probleme prilikom unosa podataka
